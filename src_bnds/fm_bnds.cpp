 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  natmort_f.allocate(.1,.16,phase_m_f,"natmort_f");
  natmort_m.allocate(.1,.16,phase_m_m,"natmort_m");
  Linf_f.allocate(30.,45.,phase_grwth,"Linf_f");
  K_f.allocate(.1,0.4,phase_grwth,"K_f");
  t0_f.allocate(0.1,0.6,phase_grwth,"t0_f");
  Linf_m.allocate(25.,45.,phase_grwth,"Linf_m");
  K_m.allocate(.1,0.4,phase_grwth,"K_m");
  t0_m.allocate(0.1,0.8,phase_grwth,"t0_m");
  ...
  F40.allocate(1,nfsh,0.01,1.,phase_F40,"F40");
  F35.allocate(1,nfsh,0.01,1.,phase_F40,"F35");
  F30.allocate(1,nfsh,0.01,1.,phase_F40,"F30");
