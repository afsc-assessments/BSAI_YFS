 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  sel_slope_fsh_m.allocate(1,nfsh,phase_male_sel,"sel_slope_fsh_m");
  male_sel_offset.allocate(-4,4,phase_male_sel_offset,"male_sel_offset");
  sel_slope_fsh_devs_m.allocate(1,nfsh,styr,endyr,-5,5,phase_male_sel,"sel_slope_fsh_devs_m");
  sel50_fsh_m.allocate(1,nfsh,phase_male_sel,"sel50_fsh_m");
  sel50_fsh_devs_m.allocate(1,nfsh,styr,endyr,-10,10,phase_male_sel,"sel50_fsh_devs_m");
