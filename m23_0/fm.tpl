...
PARAMETER_SECTION
  ...
  number sel50_tmp
  // fishery males
  init_vector sel_slope_fsh_m(1,nfsh,phase_male_sel) //phase_logist_sel
  init_bounded_number male_sel_offset(-4,4,phase_male_sel_offset)  //
  init_bounded_matrix sel_slope_fsh_devs_m(1,nfsh,styr,endyr,-5,5,phase_male_sel) //phase_logist_sel_devs
  init_vector sel50_fsh_m(1,nfsh,phase_male_sel) //phase_logist_sel
  init_bounded_matrix sel50_fsh_devs_m(1,nfsh,styr,endyr,-10,10,phase_male_sel)  //phase_logist_sel_devs
...
FUNCTION get_selectivity
  ...
  //  time-varying selectivy calculations, by sex for the fishery, females first
    for (k=1;k<=nfsh;k++)
    {
     ...
     //  males use same params as for females
...
FUNCTION Write_R
  ...
  */ 
  ...
  R_report <<"nsmpl_fsh_s"<<endl<<nsmpl_fsh_s<< endl;
